...
const LoadingWrapper = styled.div`width:100%;height:100%;min-height:200px;display:flex;align-items:center;justify-content:center;background-color:#f8f8f8;
> img{width:50%;}
`
interface props{
    width:number;
