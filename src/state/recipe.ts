    ...
    default:{
...

        {
            ...
            step:[{
                id:1,
                recipeId:3,
                imgUrl:"/new/soup/1.jpg",
                description:"깨끗이 씻은 대파는 반으로 갈라 1~2cm 두께로 썬다."
            },{
                id:2,
                recipeId:3,
                imgUrl:"/new/soup/2.jpg",
                description:"달군 냄비에 올리브오일 4큰술을 두른 후 약불에서 대파와 감자를 넣고 볶는다."
            },{
                id:3,
                recipeId:3,
                imgUrl:"/new/soup/3.jpg",
                description:"볶은 재료에 비비고 사골곰탕을 붓고 뚜껑을 덮어 10분간 중불에서 끓여준다"
            },{
                id:4,
                recipeId:3,
                imgUrl:"/new/soup/4.jpg",
                description:"완성된 수프를 접시에 담고 노릇하게 토치로 그을린 대파 1조각과 올리브오일, 후춧가루를 뿌려 맛있게 즐긴다"
            }]
...

        {
            ...
            step:[{
                id:1,
                recipeId:3,
                imgUrl:"/new/ham/1.jpg",
                description:"토마토는 0.5cm 두께로 썰고, 잎상추는 깨끗이 씻어 물기를 제거한다."
            },{
                id:2,
                recipeId:3,
                imgUrl:"/new/ham/2.jpg",
                description:"달군 팬에 버터를 넣어 녹으면, 햄버거빵을 넣고 안쪽면을 노릇하게 굽는다."
            },{
                id:3,
                recipeId:3,
                imgUrl:"/new/ham/3.jpg",
                description:"달군 팬에 약간의 올리브유를 둘러 고메함박스테이크를 올린 후, 약간의 소금 후추를 뿌려주세요. 중불에서 고메함박스테이크를 뒤집게로 눌러가며 양쪽면을 노릇하게 익힌다. "
            },{
                id:4,
                recipeId:3,
                imgUrl:"/new/ham/5.jpg",
                description:"햄버거빵 위에 구워진 고메함박스테이크를 올리고, 토마토 슬라이스 2장-잎상추-소스를 바른 햄버거빵 순으로 올린다."
            }]
